  ...
  describe '.deserialize' do
    context 'when transfer' do
      ...
      context 'and multisig' do
        let(:data) { '' }
        let(:tx) do
          {
            type: 4100,
            version: -1744830463,
