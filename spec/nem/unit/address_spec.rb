...
describe Nem::Unit::Address do
  ...
  describe 'from_public_key' do
    ...
    context 'mainnet' do
      ...
      let(:address) { Nem::Unit::Address.new('NDD2CT6LQLIYQ56KIXI3ENTM6EK3D44P5JFXJ4R4').to_s }
      let(:network) { :mainnet }
    ...
    context 'testnet' do
      ...
      let(:address) { Nem::Unit::Address.new('TDPP2C4XQLMESBMCYGWN4NRAJAKZEYRV75KGYSOB').to_s }
      let(:network) { :testnet }
